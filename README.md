...
- **Priority-based greedy scheduling** — Tasks are sorted by priority (1 = High → 3 = Low) and packed into the owner's daily time budget. High-priority tasks like medication always get scheduled first.
